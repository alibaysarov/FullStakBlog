...
const Post = ({ title, content, views, tags, postImg, _id, likes, time }) => {
  const PostImg = styled(CardMedia)(({ theme }) => ({
  ...
  return (
    <Card flexGrow={1} flexBasis={"100%"} width={"100%"}>
      ...
      />
      <PostImg component="img" height="427" image={postImg} alt={title} />
      <CardContent padding={0.7}>
        ...
        <Stack direction={"row"} justifyContent="space-between">
          ...
          <Box sx={{ display: "flex", alignItems: "end", gap: 0.6 }}>
            <VisibilityIcon />
