...
export const addLike=createAsyncThunk('posts/setLike',async({id},{getState})=>{
...
export const getQueriedPosts=createAsyncThunk('posts/filterPosts',async(query,{rejectWithValue})=>{
  try {
